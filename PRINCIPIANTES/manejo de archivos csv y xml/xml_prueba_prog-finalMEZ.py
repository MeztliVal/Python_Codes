...
def lee_xml():
    ...
    print('Aqui van a modificarse los diccionarios\n')
    print(todos_list)
    for sexo in root.iter('sexo'):
        if sexo.text == 'M':
            ...
            todos_list[x]['sexo']= 'H'
        x+=1
    print('Imprimiento Diccionarios Modificados\n')
    print(todos_list)
    ...
    a+=12
    c.setFillColor(black)
    c.drawString(30,684-a,'NP')
    c.drawString(65,684-a,'Paterno')
    c.drawString(185,684-a,'Materno')
    c.drawString(315,684-a,'Nombre')
    c.setFillColor(blue)
    a+=12
    for element in todos_list:
        sexo=todos_list[b]['sexo']
